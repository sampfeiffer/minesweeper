class TileRevealResult:
    ...
    def __init__(self, non_mines_uncovered=0, hit_mine=False, mine_tiles=[]):
        '''
        Args:
            ...
            mine_tiles (list<Tile>): A list of tiles clicked that contain a mine. Defaults to an empty list.
        '''
    ...
    def __str__(self):
        return 'TileRevealResult(non_mines_uncovered={}, hit_mine={}, mine_tiles={})'.format(self.non_mines_uncovered, self.hit_mine, self.mine_tiles)
